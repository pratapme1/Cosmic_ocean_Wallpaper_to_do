...
class CompleteLocalE2ETest {
    ...
    // ============================================
    @Test
    fun testCreateTaskLocallyDoesNotCreateDuplicates() = runTest {
        // Create a task
    ...
    // ============================================
    @Test
    fun testSyncMappingUpdatesExistingTaskWithoutDuplicate() = runTest {
        // 1. Create local task
    ...
    // ============================================
    @Test
    fun testUpdateTaskDoesNotCreateDuplicate() = runTest {
        // Create initial task
        val localId = UUID.randomUUID().toString()
    ...
    // ============================================
    @Test
    fun testSoftDeleteTask() = runTest {
        // Create task
        val localId = UUID.randomUUID().toString()
        val task = StarEntity(
            localId = localId,
    ...
    fun testWallpaperGeneratorShowsTopTask() = runBlocking {
        ...
        val tasks = listOfNotNull(topTask)
    ...
    // ============================================
    @Test
    fun testMultipleUpdatesDoNotCreateDuplicates() = runTest {
        val localId = UUID.randomUUID().toString()
    ...
    // ============================================
    @Test
    fun testSyncQueueTracksPendingOperations() = runTest {
        val localId = UUID.randomUUID().toString()
    ...
    // ============================================
    @Test
    fun testCompleteOfflineWorkflow() = runTest {
        ...
        val topTask = starDao.getTopTask()
        val tasksForWallpaper = listOfNotNull(topTask)
        val bitmap = LocalWallpaperGenerator.generate(
            tasks = tasksForWallpaper,
            totalTaskCount = tasksForWallpaper.size,
    ...
    // ============================================
    @Test
    fun testDatabaseIntegrityAfterMultipleOperations() = runTest {
    ...
    // ============================================
    @Test
    fun testWallpaperReflectsTaskChangesImmediately() = runTest {
        // Create urgent task
        ...
        val initialTasks = listOfNotNull(topTask)
        var bitmap1 = LocalWallpaperGenerator.generate(
            tasks = initialTasks,
            totalTaskCount = initialTasks.size,
            theme = WallpaperTheme.COSMIC,
            width = 1080,
            height = 1920
        )
        ...
        val updatedTasks = listOfNotNull(topTask)
        val bitmap2 = LocalWallpaperGenerator.generate(
            tasks = updatedTasks,
            totalTaskCount = updatedTasks.size,
            theme = WallpaperTheme.COSMIC,
            width = 1080,
            height = 1920
        )
